import {ContactsLink, Footer, Header, YoutubeLink, WhatsAppButton} from "../../components/shared";
import {ProjectAdvantages, ProjectInfo, ProjectSlider, ProjectBotanicalGardenResortInteraction} from "../../components/Project";
...
import projectInfoImgPc from "../../assets/content/projects/botanical-garden-resort/projectInfo/02-pc.png";

import projectInfoProgressImg from "../../assets/content/projects/botanical-garden-resort/projectInfo/01.svg";

import sliderTopImage01 from "../../assets/content/projects/botanical-garden-resort/projectSlider/top/01.jpg";
import sliderTopImage02 from "../../assets/content/projects/botanical-garden-resort/projectSlider/top/02.jpg";
import sliderTopImage03 from "../../assets/content/projects/botanical-garden-resort/projectSlider/top/03.jpg";

import sliderBottomImage01 from "../../assets/content/projects/botanical-garden-resort/projectSlider/bottom/01.jpg";
import sliderBottomImage02 from "../../assets/content/projects/botanical-garden-resort/projectSlider/bottom/02.jpg";
import sliderBottomImage03 from "../../assets/content/projects/botanical-garden-resort/projectSlider/bottom/03.jpg";

import youtubeLinkBackgroundPc from "../../assets/content/projects/botanical-garden-resort/youtubeLink/01-pc.jpg"
import youtubeLinkBackgroundMobile from "../../assets/content/projects/botanical-garden-resort/youtubeLink/01-mobile.jpg"
...
const ProjectBotanicalGardenResortPage = () => {
    ...
    return (
        <main>
            ...
            <ProjectBotanicalGardenResortInteraction/>
            <YoutubeLink backgroundMobile={youtubeLinkBackgroundMobile}
                         link='https://youtu.be/iZvyp-p6Zcg'
...
export default ProjectBotanicalGardenResortPage;